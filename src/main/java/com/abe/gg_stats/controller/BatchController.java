...
// import com.abe.gg_stats.service.EnhancedOpenDotaService;
// import com.abe.gg_stats.util.LoggingUtil;
...
//
// private final EnhancedOpenDotaService openDotaApiService;
//
// /**
...
// int remainingDailyRequests = openDotaApiService();
...
// LoggingUtil.logDebug("System status retrieved successfully", "status=healthy");
// return ResponseEntity.ok(status);
//
// }
// catch (Exception e) {
// LoggingUtil.logOperationFailure("system status retrieval", "Failed to retrieve system
// status", e);
...
// "Failed to trigger heroes update job - insufficient API requests or other
// constraints");
...
// response.put("status", "failed");
// response.put("message",
// "Failed to trigger players update job - insufficient API requests or other
// constraints");
// return ResponseEntity.badRequest().body(response);
// }
//
...
// response.put("status", "failed");
// response.put("message",
// "Failed to trigger notable players update job - insufficient API requests or other
// constraints");
// return ResponseEntity.badRequest().body(response);
// }
//
...
// response.put("status", "error");
// response.put("message", "Failed to trigger notable players update job: " +
// e.getMessage());
// return ResponseEntity.internalServerError().body(response);
// }
// }
...
// response.put("status", "failed");
// response.put("message",
// "Failed to trigger hero rankings update job - insufficient API requests or other
// constraints");
// return ResponseEntity.badRequest().body(response);
// }
//
...
// response.put("status", "error");
// response.put("message", "Failed to trigger hero rankings update job: " +
// e.getMessage());
// return ResponseEntity.internalServerError().body(response);
// }
// }

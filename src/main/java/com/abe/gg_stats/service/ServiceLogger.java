...
/**
 * Spring-managed component for service operation logging. Provides consistent logging patterns with
 * automatic correlation tracking, performance monitoring, and structured context management.
 */
@Slf4j
@Component
...
public class ServiceLogger {
  ...
  /**
   * Executes a service operation with automatic logging, timing, and context management.
   *
   ...
   */
  public <T> T executeWithLogging(String serviceName, String operation,
      ServiceOperation<T> serviceOperation, Object... context) {
  ...
  /**
   * Executes a void service operation with automatic logging, timing, and context management.
   *
   * @param serviceName      the name of the service
   * @param operation        the operation being performed
   * @param serviceOperation the operation to execute
   ...
   * @throws RuntimeException if the operation fails
   */
  public void executeWithLogging(String serviceName, String operation,
      VoidServiceOperation serviceOperation, Object... context) {
    String correlationId = MDCLoggingContext.setServiceContext(serviceName, operation);
   ...
   * @param context       additional context information
   */
  public void logServiceSuccess(String serviceName, String operation, long durationMs,
      String correlationId, Object... context) {
    checkPerformanceThresholds(serviceName, operation, durationMs);

    Object[] enhancedContext = enhanceContext(context,
  ...
  public MDCLoggingContext.ScopedContext createScopedOperation(String operation) {
    return MDCLoggingContext.createScopedContext(LoggingConstants.OPERATION_TYPE_SERVICE,
        operation);
  }
  ...
  private void checkPerformanceThresholds(String serviceName, String operation, long durationMs) {
    if (durationMs > LoggingConstants.DEFAULT_PERFORMANCE_THRESHOLD_MS) {
      LoggingUtils.logWarning("Slow service operation detected",
          "service=" + serviceName,
          "operation=" + operation,
          "duration=" + durationMs + "ms",
      ...
      LoggingUtils.logWarning("Service operation slower than expected",
          "service=" + serviceName,
          "operation=" + operation,
          "duration=" + durationMs + "ms",
  ...
  private Object[] enhanceContext(Object[] existingContext, Object... additionalContext) {
    ...
    System.arraycopy(additionalContext, 0, enhanced, existingContext.length,

...
public class ConfigurationService {
	...
	public void validateConfiguration() {
		LoggingUtils.logOperationStart("Configuration validation", "profile=" + activeProfile);
		...
		try {
			...
			LoggingUtils.logOperationSuccess("Configuration validation completed", "errors=" + validationErrors.size(),
					"warnings=" + validationWarnings.size());

		}
		catch (Exception e) {
			LoggingUtils.logOperationFailure("configuration_validation", "Configuration validation failed", e);
	...
	private void reportValidationResults(List<String> errors, List<String> warnings) {
		if (!errors.isEmpty()) {
			LoggingUtils.logOperationFailure("configuration_validation",
		...
		warnings.forEach(warning -> LoggingUtils.logWarning("Configuration warning: " + warning));
	}

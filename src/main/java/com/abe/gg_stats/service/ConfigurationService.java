...
public class ConfigurationService {
	...
	public void validateConfiguration() {
		serviceLogger.logServiceStart("ConfigurationService", "Configuration validation", "profile=" + activeProfile);
		...
		try {
			...
			serviceLogger.logServiceFailure("Configuration validation", "Configuration validation failed", e);
	...
	private void reportValidationResults(List<String> errors, List<String> warnings) {
		...
		warnings.forEach(warning -> serviceLogger.logServiceWarning("Configuration warning: " + warning));
	}

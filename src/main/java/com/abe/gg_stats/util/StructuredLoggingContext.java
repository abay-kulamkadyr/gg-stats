...
/**
 * Centralized management for structured logging context using MDC.
 * Provides thread-safe operations for setting and managing logging context
 * across different types of operations (batch, API calls, service operations).
 * 
 * Features:
...
public final class StructuredLoggingContext {
    ...
    public static String setBatchContext(@NonNull String batchType, String jobId, String stepName) {
        ...
        if (stepName != null) context.put(STEP_NAME, stepName);
    ...
    public static String setApiContext(@NonNull String endpoint, String method) {
        ...
        if (method != null) context.put(HTTP_METHOD, method.toUpperCase());
    ...
    public static void clearContext() {
        try {
            ...
            // Log the error but don't throw - clearing context should never break the application
            log.warn("Error clearing MDC context: {}", e.getMessage());
        }
    }

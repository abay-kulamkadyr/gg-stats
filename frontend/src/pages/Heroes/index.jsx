          ...
          return (
            <div key={h.heroId || idx} className="image-box">
              ...
              <div className="content">
                ...
                <Link className="btn" to={`/heroes/${encodeURIComponent(h.heroId || h.id || h.hero_id || '')}/items?heroName=${encodeURIComponent(localized)}&heroCdnName=${encodeURIComponent(cdn)}`}>
                  View
                </Link>
              </div>
            </div>
